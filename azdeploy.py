...
rg = "rsg-course-developer-associate"  # Resource Group name
location = "southeastasia"   # Azure region for the resources
...
def _preflight() -> None:
    ...
    if not dockerfile.is_file():
        print("Error: 'HelloWorld2026/Dockerfile' is missing next to azdeploy.py. "
